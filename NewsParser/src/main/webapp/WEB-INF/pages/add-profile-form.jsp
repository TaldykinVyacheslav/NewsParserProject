...
<form:form method="POST" commandName="add-profile-form.html" modelAttribute="profile" action="/settings/add">
...
<div id="content">
    <table id="tableEvent" border="2">
        ...
        <tr>
            <td><input id="SumSubmit"  type="submit" value="Add profile"></td>
            <td></td>
        </tr>
        </tbody>
    </table>
